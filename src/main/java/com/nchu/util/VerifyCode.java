...
//    	BufferedImage bim=new VerifyCode().generateImageCode(VerifyCode.generateTextCode(VerifyCode.TYPE_UPPER_ONLY,4,null), 90, 30, 3,true,Color.WHITE,Color.BLACK,null);
