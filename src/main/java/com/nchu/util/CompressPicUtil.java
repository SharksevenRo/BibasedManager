 ...
 */  
 public class CompressPicUtil {   
    ...
    public static void main(String[] arg) {   
        ...
        System.out.println("输入的图片大小：" + mypic.getPicSize("e:\\images\\1.jpg")/1024 + "KB");   
        int count = 0; // 记录全部图片压缩所用时间  
        for (int i = 0; i < 10; i++) {   
            int start = (int) System.currentTimeMillis();   // 开始时间   
            mypic.compressPic("e:\\images", "e:\\images\\compress\\", i+".jpg", i+".jpg", 120, 120, true);   
            int end = (int) System.currentTimeMillis(); // 结束时间   
            int re = end-start; // 但图片生成处理时间   
            count += re; System.out.println("第" + (i+1) + "张图片压缩处理使用了: " + re + "毫秒");   
            System.out.println("输出的图片大小：" + mypic.getPicSize("e:\\images\\compress\\"+i+".jpg")/1024 + "KB");   
        }  
